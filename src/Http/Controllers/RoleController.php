 ...
 * Role controller
 *
 * @package USoftech\User\Http\Controllers
 *
...
namespace USoftech\User\Http\Controllers;

use USoftech\User\Models\Role;
use USoftech\User\Models\Permission;
use Illuminate\Http\Request;
use USoftech\User\Http\Requests\RoleRequest;
